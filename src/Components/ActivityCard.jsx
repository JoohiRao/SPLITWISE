...
function ActivityCard() {
  return (
    <div className='w-full h-full text-white p-5 bg-black'>
      ...
      <div className="w-72 rounded-2xl shadow-lg bg-gradient-to-br from-teal-100 to-indigo-200 overflow-hidden cursor-pointer transform group hover:scale-105 group-hover:rotate-3d group-hover:flip-x transition-all duration-700 ease-in-out">
